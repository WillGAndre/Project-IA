...
class guards_BFS_GP {
  ...
  public static void main(String args[]) {
    ...
    for (int index = 1; index <= numInstan; index++) {
      ...
      queue.clear(); sv_depth.clear();
      sv_Arr.clear(); sv_Ocorr.clear(); sv_Solut.clear();
  ...
  */
  ...
  static LinkedList<Coor> str_State(Hashtable<Coor,Integer> coor_Ocorr, boolean arr_Rec[]) {
    ...
    while (!cand.isEmpty()) {
      ...
      if (res_optimo.isEmpty()) {
        res_optimo.add(bfs(c1,coor_Ocorr,arr_Rec));
      } else {
          queue.clear(); sv_depth.clear(); // Gb Col
          sv_Ocorr.clear(); sv_Arr.clear(); sv_Solut.clear();
          res_optimo.add(bfs(c1,initial_coor_Ocorr,initial_arr_Rec));
      }
    }
  ...
  static LinkedList<Coor> bfs(Coor c1, Hashtable<Coor,Integer> coor_Ocorr, boolean arr_Rec[]) {
    // Empty list
